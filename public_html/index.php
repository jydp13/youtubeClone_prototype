...
session_start();
  if(isset($_GET['category'])){
   ...
   // if (isset($_GET['category'])=="admin_home") {
   //   $page="admin_home";
   // }
   // if(isset($_GET['category'])=="groups"){
   //    $page="groups";
   // }
   if(isset($_GET['error'])=="videoerror"){
    echo "video formet not suported";
   }
   else if(isset($_GET['error'])=="imageerror"){
         ...
         case 'account':
                if(isset($_GET['page'])=="signup"){
                ...
                else if(isset($_SESSION['emailid']))
                 {
                  ...
                  else if(isset($_GET['state']) && $_GET['state']=="4"){

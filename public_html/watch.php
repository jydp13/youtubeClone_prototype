<?php
  ...
  if ($_GET['usertype']=="admin") {
   ...
   //_________________________None admin watch________________________________________________________
   else{
...
<div style="overflow: hidden;width: 30%;height: 100%;" id="side_video">
 <div id="watch_right" onscroll="yHandler()"  style="background-color: blue; width: 29%;  padding-top: 50px; position: fixed; left: 72%; overflow-y: scroll; height: 85%; overflow-x: hidden;" > 
  ...
  <input type="submit" name="" onclick="timer(8);" value="Top" style="width: 29%;margin-top: 630px; position: fixed;left: 975px;">
<?php
}
